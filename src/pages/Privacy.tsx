      ...
      <>
        ...
        <p className="text-zinc-700 dark:text-zinc-300 leading-relaxed">
          ...
          <a
            ...
            className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300 underline transition-colors duration-300"
          >
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileHover={{
          scale: 1.01,
          boxShadow: "0 12px 48px rgba(63, 63, 70, 0.15)",
        }}
      >
